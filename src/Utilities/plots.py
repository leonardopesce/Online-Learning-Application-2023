...
def plot_all_algorithms(reward_per_algorithm, best_rewards, x_range, labels, step_name=''):
    ...
    axes[0].axvline(x=14, color='green', linestyle='-.')
    ...
    axes[1].axvline(x=14, color='green', linestyle='-.')
    ...
    axes[2].axvline(x=14, color='green', linestyle='-.')
    ...
    axes[3].axvline(x=14, color='green', linestyle='-.')
