...
class ContextGeneratorLearner:
    ...
    Attributes:
        ...
        time_between_context_generation: Number of time steps between the application of the context generation
            algorithm
    ...
    def __init__(self, prices, bids, feature_names, feature_values, time_between_context_generation, learner_type, other_costs):
        ...
        :param dict feature_values: Dictionary containing the mapping between the features and the values the features
            can assume, the format is {feature_name: [value0, value1, value2, ...]}
        :param int time_between_context_generation: Number of time steps between the application of the context
            ...
            for context in new_contexts:
                ...
                for key in new_learner_feature_to_obs.keys():
                    ...
                    for idx, observation in enumerate(new_learner_feature_to_obs.get(key)):
                        ...
                        #new_learner.update(observation[0], np.concatenate((observation[1], bernoulli_obs_other_classes)), observation[2], observation[3] + mean_clicks, observation[4] + mean_costs, observation[5], False)
                        new_learner.update(observation[0], observation[1], observation[2], observation[3], observation[4], observation[5], False)
